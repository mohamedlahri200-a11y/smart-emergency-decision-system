...
// src/components/dashboard/radiologue/RadiologueDashboardPage.tsx
import React, { useCallback, useEffect, useState } from "react";

import DashboardLayout from "../../../layouts/dashboard/DashboardLayout";
import RadiologueKpiCards from "./RadiologueKpiCards";
...
import CriticalExamAlertBanner from "../shared/CriticalExamAlertBanner";
...
const RadiologueDashboardPage: React.FC = () => {
    ...
    return (
        <DashboardLayout title="Dashboard Radiologue" subtitle="Demandes d'imagerie transmises par les urgences">
            <CriticalExamAlertBanner
                examens={enAttente.filter((e) => e.prioriteTriage === "Rouge")}
                onExamenClick={setSelectedExamenId}
                typeLabel="d'imagerie"
            />

            <RadiologueKpiCards stats={stats} />
...
export default RadiologueDashboardPage;
