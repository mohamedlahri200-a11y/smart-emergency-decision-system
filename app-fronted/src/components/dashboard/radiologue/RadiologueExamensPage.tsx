// src/components/dashboard/radiologue/RadiologueExamensPage.tsx
...
const RadiologueExamensPage: React.FC = () => {
    ...
    return (
        <DashboardLayout title="Examens à réaliser" subtitle="Demandes d'imagerie en attente ou en cours">
            ...
            <Box sx={{ mb: 1 }}>
                <Typography variant="body2" color="text.secondary">
                    {filtered.length} examen{filtered.length > 1 ? "s" : ""} à traiter
                </Typography>
            </Box>

            <ExamensATraiterTable examens={filtered} loading={loading} onRowClick={setSelectedExamenId} title="Liste des examens" />
...
export default RadiologueExamensPage;
